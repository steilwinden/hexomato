...
public class GameRepositoryImpl implements GameRepository {
    ...
    public List<Game> loadCurrentGames() {
        ...
        List<GameEntity> gameEntityList = gameEntityRepository.findAllByCreatedOnAfterOrderByHumanPlayer1AscHumanPlayer2AscNamePlayer1AscNamePlayer2Asc(pointInTime);
